declare namespace TXTextControl {
    ...
    interface ImageCollection extends FrameBaseCollection<Image> {
        /**
         ...
         */
        addAnchored(imageData: string, horizontalAlignment: HorizontalAlignment, textPosition: number, insertionMode: ImageInsertionMode, callback?: RequestImageCallback, errorCallback?: ErrorCallback): void;
        /**
         ...
         * @param errorCallback Optional. Is called when the operation failed with an error.
         */
        addAnchoredAtLocation(imageData: string, location: Point, textPosition: number, insertionMode: ImageInsertionMode, callback?: RequestImageCallback, errorCallback?: ErrorCallback): void;
        /**
         ...
         */
        addAtFixedPosition(imageData: string, pageNumber: number, location: Point, insertionMode: ImageInsertionMode, errorCallback?: ErrorCallback): void;
        /**
         ...
         * @param errorCallback Optional. Is called when the operation failed with an error.
         */
        addAtFixedPositionInDocument(imageData: string, location: Point, insertionMode: ImageInsertionMode, callback?: RequestImageCallback, errorCallback?: ErrorCallback): void;
        /**
         * Inserts a new image which has a fixed geometrical position in the document.
         * @param imageData The base64 encoded image data.
         ...
         * @param errorCallback Optional. Is called when the operation failed with an error.
         */
        addAtFixedPositionOnPage(imageData: string, pageNumber: number, location: Point, insertionMode: ImageInsertionMode, callback?: RequestImageCallback, errorCallback?: ErrorCallback): void;
        /**
