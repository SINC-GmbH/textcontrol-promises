declare namespace TXTextControl {
    ...
    interface MisspelledWordCollection extends Collection<MisspelledWord> {
        ...
        getItemAtTextPosition(textPosition: number, kind: MisspelledWordKind, callback: RequestMisspelledWordCallback, errorCallback?: ErrorCallback): void;
        /**
