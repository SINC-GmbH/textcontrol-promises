declare namespace TXTextControl {
  ...
  export interface TableCellCollection extends Collection<TXTextControl.TableCell> {
    getItem: (
  ...
  export interface TableColumnCollection extends Collection<TXTextControl.TableColumn> {
    //TODO: update function declaration
  }

  export interface TableBaseCollection extends Collection<TXTextControl.Table> {
    getItem: (
  ...
  export interface SubTextPartCollection extends Collection<TXTextControl.SubTextPart> {
    add: (
      name: string,
      id: number,
      start: number,
  ...
  export interface EditableRegionCollection extends Collection<TXTextControl.EditableRegion> {
    forEach: (
  ...
  export interface FormFieldCollection extends Collection<TXTextControl.FormField> {
    forEach: (
  ...
  export interface TextFieldCollectionBase extends Collection<TXTextControl.TextField> {
  ...
  export interface TextFieldCollection extends Collection<TXTextControl.TextField> {
    getItem(
