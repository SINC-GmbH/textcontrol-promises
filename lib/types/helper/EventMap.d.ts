import {
    BarcodeCallback,
    CannotTrackChangeCallback,
    ChartCallback,
    CheckFormFieldCallback,
    ClipboardDataTransferAbortedCallback,
    ClipboardDataTransferCompleteCallback,
    ClipboardDataTransferProgressCallback,
    ClipboardDataTransferStartCallback,
    ClipboardModeChangedCallback,
    CommentEventCallback,
    ContextMenuEventCallback,
    DateFormFieldCallback,
    DocumentLinkCallback,
    DocumentLoadedCallback,
    DrawingCallback,
    EditableRegionCallback,
    ErrorCallback,
    EventCallback,
    FileDroppedCallback,
    FootnoteCallback,
    ...
    HypertextLinkClickedCallback,
    HyphenateWordCallback,
    ImageCallback,
    InputPositionChangedCallback,
    ReconnectionFailedCallback,
    RequestSizeCallback,
    RibbonTabIndexChangedCallback,
    RibbonTabLoadedCallback,
    RibbonTabsLoadedCallback,
    SelectionFormFieldCallback,
    SignatureFieldCallback,
    SpellCheckTextCallback,
    SubTextPartCallback,
    TableCallback,
    ...
    TextFrameCallback,
    TextPastedCallback,
    TextViewLocationChangedCallback,
    TrackedChangeCallback,
