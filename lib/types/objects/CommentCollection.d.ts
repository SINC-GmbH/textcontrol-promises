import { AddCommentCallback, RequestCommentCallback, RequestBooleanCallback } from '../callbacks';
 ...
 */
export interface CommentCollection extends Collection<CommentedText> {
