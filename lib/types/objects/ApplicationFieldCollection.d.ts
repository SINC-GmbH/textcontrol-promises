import { RequestApplicationFieldCallback, RequestBooleanCallback } from "../callbacks";
import { ApplicationFieldFormat } from "../enums";
import { ApplicationField } from "./ApplicationField";
import { TextFieldCollectionBase } from "./TextFieldCollectionBase";

/** Contains all created or imported Microsoft Word fields represented through objects of the type ApplicationField. */
export interface ApplicationFieldCollection extends TextFieldCollectionBase<ApplicationField> {
    /**
