import { RequestNumberFormatCallback, RequestBooleanCallback, RequestNumberCallback, EmptyRequestCallback } from '../callbacks';
...
export interface PageNumberField extends TextField {
