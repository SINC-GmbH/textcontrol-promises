import { RequestTableOfContentsCallback, EmptyRequestCallback } from '../callbacks';
import { Collection } from './Collection';
import { TableOfContents } from './TableOfContents';
import { TableOfContentsCollectionAddParams } from './TableOfContentsCollectionAddParams';

/** Contains all tables of contents in a certain part of the document. */
export interface TableOfContentsCollection extends Collection<TableOfContents> {
