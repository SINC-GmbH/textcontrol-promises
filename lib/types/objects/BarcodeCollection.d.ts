import { RequestBarcodeFrameCallback, EmptyRequestCallback } from "../callbacks";
import { BarcodeType, HorizontalAlignment, FrameInsertionMode } from "../enums";
...
export interface BarcodeCollection extends FrameBaseCollection<BarcodeFrame> {
    /**
