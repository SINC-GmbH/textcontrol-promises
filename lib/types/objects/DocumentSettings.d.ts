import { RequestStringCallback, RequestNumberCallback, RequestStringsCallback, RequestObjectCallback, EmptyRequestCallback } from '../callbacks';
import { EmbeddedFileCollection } from './EmbeddedFileCollection';
