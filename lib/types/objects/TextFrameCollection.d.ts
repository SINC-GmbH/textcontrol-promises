import { RequestTextFrameCallback, EmptyRequestCallback } from '../callbacks';
import { HorizontalAlignment, TextFrameInsertionMode } from '../enums';
...
export interface TextFrameCollection extends FrameBaseCollection<TextFrame> {
    /**
     ...
     * @param errorCallback Optional. Is called when the operation failed with an error.
     */
    addInline(size: Size, textPosition: number, callback?: RequestTextFrameCallback, errorCallback?: ErrorCallback): void;
    /**
