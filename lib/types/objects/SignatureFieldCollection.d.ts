import { RequestSignatureFieldCallback, EmptyRequestCallback } from '../callbacks';
import { HorizontalAlignment, FrameInsertionMode } from '../enums';
...
export interface SignatureFieldCollection extends FrameBaseCollection<SignatureField> {
