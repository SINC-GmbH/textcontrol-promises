import { RequestPageNumberFieldCallback, RequestBooleanCallback } from '../callbacks';
...
export interface PageNumberFieldCollection extends TextFieldCollectionBase<PageNumberField> {
