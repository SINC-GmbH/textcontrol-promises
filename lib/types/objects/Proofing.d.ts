...
export interface Proofing {
     ...
     */
    addWordToUserDictionary(name: string, words: string[]): void;
    /** Retrieves a list of the names of all dictionary files on the server. */
    getDictionaryList(callback: GetDictionaryListCallback): void;
    /** Retrieves information about all currently existing user dictionaries via a callback function. */
    getUserDictionaryInfo(callback: GetUserDictionaryInfoCallback): void;
    /** Loads a dictionary. */
     ...
     */
    loadUserDictionary(name: string, words: string[], language: string): void;
    /** Removes a dictionary from the loaded dictionaries. */
    removeDictionary(fileName: string): void;
    /** Removes an existing user dictionary. */
    removeUserDictionary(name: string): void;
    /** Removes a word from an existing user dictionary. */
    removeWordFromUserDictionary(name: string, words: string[]): void;
    /** Saves an existing user dictionary by supplying the contained words as a string array to a callback function. */
    saveUserDictionary(name: string, callback: SaveUserDictionaryCallback): void;
}
