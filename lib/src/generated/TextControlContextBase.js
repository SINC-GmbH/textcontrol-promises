...
/** @import {EventMap} from "../../types/TXTextControlTypeDefinition" */
...
export class TextControlContextBase {
     ...
     */
    init(settings) {
        return TXTextControl.init(settings);
    }
     ...
     * @type {TXTextControlTypeDefinition.BarcodeTypeSettings}
     */
    get barcodeTypeSettings() { return TXTextControl.barcodeTypeSettings; }

    /**
     * Gets a collection of all barcode frames contained in the text part with the input focus.
     * @type {TXTextControlTypeDefinition.BarcodeCollection}
     */
    get barcodes() { return TXTextControl.barcodes; }
     ...
     * @type {TXTextControlTypeDefinition.CommentCollection}
     */
    get comments() { return TXTextControl.comments; }
     ...
     * @type {TXTextControlTypeDefinition.TextViewGeneratorColors}
     */
    get displayColors() { return TXTextControl.displayColors; }

    /**
     * Gets a collection of all links which point to targets in the same document.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.DocumentLinkCollection}
     */
    get documentLinks() { return TXTextControl.documentLinks; }

    /**
     * The document permission settings.
     * @type {TXTextControlTypeDefinition.DocumentPermissions}
     */
    get documentPermissions() { return TXTextControl.documentPermissions; }
     ...
     * @type {TXTextControlTypeDefinition.DocumentSettings}
     */
    get documentSettings() { return TXTextControl.documentSettings; }
     ...
     * @type {TXTextControlTypeDefinition.DocumentTargetCollection}
     */
    get documentTargets() { return TXTextControl.documentTargets; }
     ...
     * @type {TXTextControlTypeDefinition.FootnoteCollection}
     */
    get footnotes() { return TXTextControl.footnotes; }
     ...
     * @type {TXTextControlTypeDefinition.FrameCollection}
     */
    get frames() { return TXTextControl.frames; }

    /**
     * Gets a collection of all headers and footers in the document.
     * @type {TXTextControlTypeDefinition.HeaderFooterCollection}
     */
    get headersAndFooters() { return TXTextControl.headersAndFooters; }

    /**
     * Gets a collection of all hypertext links.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.HypertextLinkCollection}
     */
    get hypertextLinks() { return TXTextControl.hypertextLinks; }

    /**
     * Gets a collection of all images contained in the text part with the input focus.
     * @type {TXTextControlTypeDefinition.ImageCollection}
     */
    get images() { return TXTextControl.images; }

    /**
     * Gets a collection of all inline styles the current document contains.
     * @type {TXTextControlTypeDefinition.InlineStyleCollection}
     */
    get inlineStyles() { return TXTextControl.inlineStyles; }

    /**
     * All formatting attributes at the current text input position.
     * @type {TXTextControlTypeDefinition.InputFormat}
     */
    get inputFormat() { return TXTextControl.inputFormat; }
     ...
     * @type {TXTextControlTypeDefinition.LineCollection}
     */
    get lines() { return TXTextControl.lines; }

    /**
     * The type and the formatting attributes of a bulleted or numbered list.
     * @type {TXTextControlTypeDefinition.ListFormat}
     */
    get listFormat() { return TXTextControl.listFormat; }

    /**
     * Gets a collection of all misspelled words.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.MisspelledWordCollection}
     */
    get misspelledWords() { return TXTextControl.misspelledWords; }

    /**
     * The margins for the pages of the current document.
     * @type {TXTextControlTypeDefinition.PageMargins}
     */
    get pageMargins() { return TXTextControl.pageMargins; }

    /**
     * The width and height of the pages for the current document.
     * @type {TXTextControlTypeDefinition.PageSize}
     */
    get pageSize() { return TXTextControl.pageSize; }

    /**
     * Gets a collection of all pages in the document.
     * @type {TXTextControlTypeDefinition.PageCollection}
     */
    get pages() { return TXTextControl.pages; }
     ...
     * @type {TXTextControlTypeDefinition.ParagraphStyleCollection}
     */
    get paragraphStyles() { return TXTextControl.paragraphStyles; }

    /**
     * Gets a collection of all paragraphs.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.ParagraphCollection}
     */
    get paragraphs() { return TXTextControl.paragraphs; }

    /**
     * Gets the control's ribbon bar object.
     * @type {TXTextControlTypeDefinition.Ribbon}
     */
    get ribbon() { return TXTextControl.ribbon; }

    /**
     * Returns the "Permissions" ribbon tab object.
     * @type {TXTextControlTypeDefinition.RibbonPermissionsTab}
     */
    get ribbonPermissionsTab() { return TXTextControl.ribbonPermissionsTab; }

    /**
     * The horizontal ruler bar.
     * @type {TXTextControlTypeDefinition.RulerBarViewGenerator}
     */
    get rulerBar() { return TXTextControl.rulerBar; }
     ...
     * @type {TXTextControlTypeDefinition.SectionCollection}
     */
    get sections() { return TXTextControl.sections; }
     ...
     * @type {TXTextControlTypeDefinition.SideBarToggleButton}
     */
    get sideBarToggleButton() { return TXTextControl.sideBarToggleButton; }

    /**
     * Gets a collection of all signature fields in the document.
     * @type {TXTextControlTypeDefinition.SignatureFieldCollection}
     */
    get signatureFields() { return TXTextControl.signatureFields; }

    /**
     * The status bar.
     * @type {TXTextControlTypeDefinition.StatusBarViewGenerator}
     */
    get statusBar() { return TXTextControl.statusBar; }
     ...
     * @type {TXTextControlTypeDefinition.TableOfContentsCollection}
     */
    get tablesOfContents() { return TXTextControl.tablesOfContents; }

    /**
     * Gets a collection of all text characters.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.TextCharCollection}
     */
    get textChars() { return TXTextControl.textChars; }

    /**
     * Gets a collection of all standard text fields.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.TextFieldCollection}
     */
    get textFields() { return TXTextControl.textFields; }
     ...
     * @type {TXTextControlTypeDefinition.TextFrameCollection}
     */
    get textFrames() { return TXTextControl.textFrames; }
     ...
     * @type {TXTextControlTypeDefinition.TextPartCollection}
     */
    get textParts() { return TXTextControl.textParts; }

    /**
     * Gets a collection of all tracked changes.(Inherited from FormattedText)
     * @type {TXTextControlTypeDefinition.TrackedChangeCollection}
     */
    get trackedChanges() { return TXTextControl.trackedChanges; }

    /**
     * The vertical ruler bar.
     * @type {TXTextControlTypeDefinition.RulerBarViewGenerator}
     */
    get verticalRulerBar() { return TXTextControl.verticalRulerBar; }
