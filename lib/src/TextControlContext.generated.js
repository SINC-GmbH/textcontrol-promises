...
export class TextControlContextBase {
     ...
     * @param {MergeField | IfField | IncludeTextField | DateField | NextField | NextIfField} mergeField The merge field.
     */
    ...
    /**
     * @deprecated
     * @param {TextField | ApplicationField} textField
     */
     ...
     * @param {StreamType} streamType Specifies one of the numerical StreamType values.
     ...
     * @param {LoadSettings | null} loadSettings Additional settings for appending the data. Can be null.
     * @param {AppendSettings} appendSettings Settings on how the document is appended.
     ...
     * @param {FindOptions | null} options Optional. Specifies search options. It can be a combination of the FindOptions values.
    ...
    /**
     * @deprecated
     * @param {FileType} fileType Must be one of the FileType values.
     * @returns {Promise<string>}
     */
    ...
    /**
     * @deprecated
     * @param {TextField | ApplicationField} textField The text field to remove from the document.
     ...
     * @param {ActivationState} activationState
     * @returns {Promise<void>}
     */
     ...
     * @param {FontUnderlineStyle} style
     * @returns {Promise<void>}
     */
     ...
     * @param {FormulaReferenceStyle} style
     * @returns {Promise<void>}
     */
     ...
     * @param {TextFieldPosition} textFieldPosition
     * @returns {Promise<void>}
     */
     ...
     * @param {PermanentControlChar} permanentControlChars
     * @returns {Promise<void>}
     */
     ...
     * @param {ComponentRenderMode} value
     * @returns {Promise<void>}
     */
    setRenderMode(value) {
        return RequestHelper.Promise(
     ...
     * @param {DialogBoxKind} dialogBoxKind The dialog box kind.
     ...
     * @param {HtmlDialogBoxKind} dialogBoxKind
     */
     ...
     * @param {number | SpecialZoomFactor} zoomFactor Specifies the zoom factor, in percent. This can also be one of the values of the TXTextControl.SpecialZoomFactor enumeration.
     * @returns {Promise<void>}
     */
    zoom(zoomFactor) {
        return RequestHelper.Promise(
